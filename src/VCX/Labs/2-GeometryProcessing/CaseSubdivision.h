...
namespace VCX::Labs::GeometryProcessing {
    ...
    class CaseSubdivision : public Common::ICase {
    public:
        CaseSubdivision(Viewer & viewer, std::initializer_list<Assets::ExampleModel> && models);

        virtual std::string_view const GetName() override { return "Mesh Subdivision"; }
